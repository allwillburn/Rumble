...
function AutoUpdate(data)
    if tonumber(data) > tonumber(ver) then
        ...
        DownloadFileAsync('https://github.com/allwillburn/Rumble/blob/master/Rumble.lua', SCRIPT_PATH .. 'Rumble.lua', function() PrintChat('<font color = "#00FFFF">Update Complete, please 2x F6!') return end)
    else
...
RumbleMenu.AutoIgnite:Boolean("Ignite", "Ignite if killable", true)
